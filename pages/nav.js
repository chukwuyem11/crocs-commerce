...
const Heading = (props) => {
  ...
  return (
    <Box>
        ...
        <Flex pos="fixed" pl={10} pr={12}   w="100%" zIndex={2}  bg={scrollPos > 20 ? "#ffffff" : ""} boxShadow = {scrollPos > 20 ? "lg" : ""} h= {scrollPos > 20 ? "75px" : ""} >
            <Box p={5} >
            <Link href="/home">
  <Image src="logo.png" boxSize="100px" mt="-30px"  alt="Segun Adebayo" />
            ...
            <Link href="/shop">
            <Box p={5}>
              <Text color={scrollPos > 20 ? "#000000" : "#000000"}>
                Shop
                </Text>
            </Box>
            </Link>
  ...
  _expanded={{ bg: "transparent" }}
    as={IconButton}
    aria-label="Options"
    icon={<GiHamburgerMenu color={scrollPos > 20 ? "#000000" : "#000000"}/>}
    variant="outline"
  />
  <MenuList bg="#ffffff">
    ...
    <Link href="/admin">
            ...
            <Box display={['none', 'block', 'block']} ref={btnRef} onClick={onOpen} p={5} color={scrollPos > 20 ? "#000000" : "#000000"}>
              {cartTotal}
            <Icon ref={btnRef}  ml="5px" color={scrollPos > 20 ? "#000000" : "#000000"} fontSize="20px" as={RiShoppingCartLine}/>

            
            </Box>
            <Box display={['block', 'none', 'none']} ref={btnRef} onClick={onOpen} p={5} color={scrollPos > 20 ? "#000000" : "#000000"}>
  ...
  <Flex justifyContent="space-between" w="100%"><Box fontSize="20" fontWeight="bold">Total Price: {cartTotal}</Box><Box><Button  mr={3} onClick={() => router.push("/checkout")}>
      ...
      <Box mt="50px"  >
        <Flex bg="#9CD474
" p={5}>
          <Box><Text color="#000000" fontWeight="450" fontSize="22px">copyright 2020</Text></Box>
          <Spacer/>
          <Box><Text  color="#000000" fontWeight="450" fontSize="22px">Built by TNSOF</Text></Box>
        </Flex>
      </Box>
      </Box>
