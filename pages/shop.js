...
{ data.data.names.length === 0 ? <Center mt="50px">
  ...
  bgClip="text">
    ...
    {data.data.names.map((names) => ( <Wrap spacing="130px">
      <WrapItem>
        <Center > <Link href={`product/${names.id}`}><Box boxShadow="lg" p="6" rounded="md" bg="white"><Image src="crocs9.jpg" boxShadow="2xl" p="6" rounded="md" w="260px" h="334px" mt="-30px"  alt="Segun Adebayo"  p="0" /><Box mt="40px">
